...
class PixelRounderTests: XCTestCase {
    ...
    public func test_roundToPixel() {
        ...
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).roundToPixel(1.5) * 1000), 1667)
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).roundToPixel(CGPoint(x: 1.75, y: 1.25).x) * 1000), 1667)
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).roundToPixel(CGPoint(x: 1.75, y: 1.25).y) * 1000), 1333)
    ...
    public func test_ceilToPixel() {
        ...
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).ceilToPixel(1.1) * 1000), 1333)
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).ceilToPixel(1.5) * 1000), 1667)
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).ceilToPixel(CGPoint(x: 1.75, y: 1.25).x), 2.0)
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).ceilToPixel(CGPoint(x: 1.75, y: 1.25).y) * 1000), 1333)
    ...
    public func test_floorToPixel() {
        ...
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).floorToPixel(1.5) * 1000), 1333)
        XCTAssertEqual(round(PixelRounder(withScreenScale: 3.0).floorToPixel(CGPoint(x: 1.75, y: 1.25).x) * 1000), 1667)
