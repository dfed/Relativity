...
class PixelRounderTests: XCTestCase {
    ...
    public func test_roundToPixel() {
        ...
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).roundToPixel(1.5).roundedToThirdDecimalPoint, 1.667)
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).roundToPixel(CGPoint(x: 1.75, y: 1.25).x).roundedToThirdDecimalPoint, 1.667)
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).roundToPixel(CGPoint(x: 1.75, y: 1.25).y).roundedToThirdDecimalPoint, 1.333)
    ...
    public func test_ceilToPixel() {
        ...
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).ceilToPixel(1.1).roundedToThirdDecimalPoint, 1.333)
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).ceilToPixel(1.5).roundedToThirdDecimalPoint, 1.667)
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).ceilToPixel(CGPoint(x: 1.75, y: 1.25).x), 2.0)
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).ceilToPixel(CGPoint(x: 1.75, y: 1.25).y).roundedToThirdDecimalPoint, 1.333)
    ...
    public func test_floorToPixel() {
        ...
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).floorToPixel(1.5).roundedToThirdDecimalPoint, 1.333)
        XCTAssertEqual(PixelRounder(withScreenScale: 3.0).floorToPixel(CGPoint(x: 1.75, y: 1.25).x).roundedToThirdDecimalPoint, 1.667)
